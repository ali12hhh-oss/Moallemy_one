...
const readingPassages = <ReadingPassage>[
  ReadingPassage(
    ...
    [
      ...
      ComprehensionQuestion('ماذا فعل سعيد بالدجاج؟', [
        'أطعمه',
        'باعه',
        'لعب معه',
      ], 0),
      ComprehensionQuestion('ماذا أكل سعيد في الظهيرة؟', [
        'خبزًا',
        'تفاحة',
        'حليبًا',
      ], 1),
  ...
  ReadingPassage(
    ...
    '🏖️',
    [
      ComprehensionQuestion('متى ذهبت العائلة إلى البحر؟', [
        'السبت',
        'الجمعة',
        'الأحد',
      ], 1),
      ComprehensionQuestion('ماذا بنت نور؟', [
        'بيتًا من الخشب',
        'قلعة رملية',
        'برجًا من الحجارة',
      ], 1),
      ComprehensionQuestion('ماذا جمعوا قبل المغيب؟', [
        'الأصداف',
        'الأسماك',
        'الحصى',
      ], 0),
