            ...
            Padding(
              ...
              child: Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                    'العمر: ${stage.age}  •  الأعداد: ${stage.numberRange}',
                  ),
                ),
              ),
            ),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${arNum(p.done)} / ${arNum(stage.units.length)}',
                          ),
                        ],
                      ),
                        ...
                        child: FilledButton.icon(
                          ...
                          label: Text(
                            ready
                                ...
                                : 'أكمل دروس المرحلة لفتح الاختبار',
                          ),
                        ),
                      ),
                    ],
  ...
  Future<void> _completeUnit(CurriculumUnitV8 unit) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('تم تسجيل درس ${unit.title} ⭐')));
      setState(() {});
    }
  }
