              ...
              child: Row(children: [
                Expanded(
                  child: Button3D(
                    ...
                    child: const Center(child: Text('الحروف والكلمات', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: Colors.white))),
                  ),
                ),
                ...
                Expanded(
                  child: Button3D(
                    ...
                    depth: writingMode ? 2 : 7,
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    child: const Center(child: Text('الكتابة', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: Colors.white))),
                  ),
                ),
              ]),
            ),
            ...
            if (!writingMode)
              Expanded(
                child: ListView(
                  ...
                  children: [
                    Text('كل الحروف مع ${h.name}', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                    ...
                    Text('كلمات ممدودة بـ${h.name}', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 10),
                    Wrap(
                      spacing: 12,
                      runSpacing: 12,
              ...
              const Text('اكتب الكلمة', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              Text(word, style: const TextStyle(fontSize: 54, fontWeight: FontWeight.w900)),
