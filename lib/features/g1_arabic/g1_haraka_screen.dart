...
class _G1HarakaScreenState extends State<G1HarakaScreen> {
  ...
  static const _clearColor = Color(0xFFEF5350);
      ...
      children: [
        ...
        Expanded(
          child: Padding(
            ...
            child: Column(
              children: [
                const Text('اختر أي حرف لسماع الحرف مع الحركة', textAlign: TextAlign.center, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w800)),
                const SizedBox(height: 5),
                Expanded(
                        ...
                        child: Center(
                          child: SizedBox(
                            ...
                            child: Button3D(
                              ...
                              child: Center(child: Text(marked, textAlign: TextAlign.center, style: TextStyle(fontSize: pickerLetterSize, height: 1, fontWeight: FontWeight.w900, color: Colors.white))),
                            ),
                          ),
                        ),
                      );
                ...
                Row(
                  children: [
                    Expanded(child: Button3D(onTap: () => _move(-1), color: _previousColor, padding: const EdgeInsets.symmetric(vertical: 12), child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.arrow_back_rounded, color: Colors.white), SizedBox(width: 6), Text('السابق', style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w900))]))),
                    const SizedBox(width: 10),
                    Expanded(child: Button3D(onTap: () => _move(1), color: _nextColor, padding: const EdgeInsets.symmetric(vertical: 12), child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('التالي', style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w900)), SizedBox(width: 6), Icon(Icons.arrow_forward_rounded, color: Colors.white)]))),
                  ],
                ),
              ],
            ),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Button3D(
              ...
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.volume_up_rounded, color: Colors.white), SizedBox(width: 5), Text('استمع للحرف مع الحركة', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900))]),
            ),
          ),
        ],
      ),
