    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(padding: const EdgeInsets.all(18), children: [
          Button3D(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const G1GamesScreen())),
            ...
            child: const Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(height: 4),
                  Text('ثلاث ألعاب: عربي، إنجليزي، ورياضيات', style: TextStyle(color: Colors.white70)),
                ]),
              ),
            ]),
          ),
          ...
          Button3D(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const G1StoriesScreen())),
            ...
            child: const Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(height: 4),
                  Text('ثلاث قصص متوسطة الطول بالقراءة الصوتية', style: TextStyle(color: Colors.white70)),
                ]),
              ),
            ]),
          ),
