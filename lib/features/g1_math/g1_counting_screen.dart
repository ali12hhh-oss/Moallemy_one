            ...
            child: Column(children: [
              Row(children: [
                Expanded(
                  child: Button3D(
                    onTap: () => _switch(true),
                    color: ascending ? const Color(0xFF00C853) : const Color(0xFFA5D6A7),
                    depth: ascending ? 2 : 7,
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    child: const Center(child: Text('تصاعدي ⬆️', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Colors.white))),
                  ),
                ),
                ...
                Expanded(
                  child: Button3D(
                    onTap: () => _switch(false),
                    color: !ascending ? const Color(0xFFFF6B35) : const Color(0xFFFFCCBC),
                    depth: !ascending ? 2 : 7,
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    child: const Center(child: Text('تنازلي ⬇️', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Colors.white))),
                  ),
                ),
              ]),
              ...
              Wrap(
                ...
                spacing: 10,
                children: [
                  ...sequence.map((n) => Text(arNum(n), style: const TextStyle(fontSize: 40, fontWeight: FontWeight.w900))),
                  const Text('؟', style: TextStyle(fontSize: 40, fontWeight: FontWeight.w900, color: Colors.grey)),
                ],
              ),
              const SizedBox(height: 8),
              IconButton(icon: const Icon(Icons.volume_up_rounded), onPressed: () => VoiceService.arabic(sequence.map(arNum).join('، '))),
