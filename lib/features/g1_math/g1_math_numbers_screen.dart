...
class _G1MathNumbersScreenState extends State<G1MathNumbersScreen> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('الأرقام ١-١٠٠')),
            ...
            child: Row(children: [
              Expanded(
                child: Button3D(
                  ...
                  child: const Center(child: Text('العدّ ١-١٠٠', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Colors.white))),
                ),
              ),
              ...
              Expanded(
                child: Button3D(
                  ...
                  depth: placeValueMode ? 2 : 7,
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  child: const Center(child: Text('الآحاد والعشرات والمئات', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: Colors.white))),
                ),
              ),
            ]),
          ),
      ...
      itemBuilder: (_, i) {
        ...
        return Card(
          child: InkWell(
            ...
            child: Center(child: Text(arNum(n), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold))),
          ),
        );
      },
    );
