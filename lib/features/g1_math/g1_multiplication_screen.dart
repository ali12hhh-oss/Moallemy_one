...
class _G1MultiplicationScreenState extends State<G1MultiplicationScreen> {
  int table = 1;
  static const colors = [Color(0xFF7C4DFF), Color(0xFF2979FF), Color(0xFFFF6B35)];
      ...
      child: Scaffold(
        ...
        body: Column(children: [
          Padding(
            ...
            child: Row(children: [1, 2, 3].map((t) {
              final selected = t == table;
              return Expanded(child: Padding(padding: const EdgeInsets.symmetric(horizontal: 4), child: Button3D(
