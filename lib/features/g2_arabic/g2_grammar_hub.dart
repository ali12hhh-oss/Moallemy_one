...
class G2GrammarHub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <(String, String, String, Color, Widget)>[
      ('🔗', 'ال التعريف', 'من كلمة نكرة إلى كلمة معرفة', const Color(0xFF7C4DFF), const G2DefiniteArticleScreen()),
      ('🔢', 'مفرد، مثنى، جمع', 'واحد، اثنان، وأكثر من اثنين', const Color(0xFF2979FF), const G2NumberFormScreen()),
      ('👫', 'مؤنث ومذكر', 'الفرق بين الكلمة المؤنثة والمذكرة', const Color(0xFFFF1E7E), const G2GenderScreen()),
      ('🏷️', 'الاسم والفعل', 'ميّز بين الأسماء والأفعال', const Color(0xFF00C853), const G2NounVerbScreen()),
    ];
