...
class G2ReadHub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <(String, String, String, Color, Widget)>[
      ('2️⃣', 'كلمات من حرفين', 'دمج حرفين لتكوين كلمة', const Color(0xFF7C4DFF), const G1ReadWordsScreen(words: twoLetterWords, title: 'كلمات من حرفين')),
      ('3️⃣', 'كلمات من ثلاثة أحرف', 'دمج ثلاثة أحرف وتهجئتها', const Color(0xFFFF1E7E), const G1ReadWordsScreen(words: threeLetterWords, title: 'كلمات من ثلاثة أحرف')),
      ('4️⃣', 'كلمات من أربعة أحرف', 'دمج أربعة أحرف وتهجئتها', const Color(0xFF00BFA6), const G1ReadWordsScreen(words: fourLetterWords, title: 'كلمات من أربعة أحرف')),
      ('📝', 'جمل من مقطعين', 'اقرأ جملًا قصيرة كاملة', const Color(0xFF2979FF), const G2SentenceReadScreen()),
    ];
