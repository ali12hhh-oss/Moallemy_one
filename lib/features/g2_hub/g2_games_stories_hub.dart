          ...
          children: [
            Button3D(
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const G2GamesScreen()),
              ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text(
                          'أربع ألعاب: قراءة، إنجليزي، رياضيات، وقواعد',
            ...
            Button3D(
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const G2StoriesScreen()),
              ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text(
                          'أربع قصص أطول، بقراءة صوتية كاملة',
                          style: TextStyle(color: Colors.white70),
                        ),
                      ],
                    ),
