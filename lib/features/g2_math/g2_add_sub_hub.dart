    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(padding: const EdgeInsets.all(18), children: [
          Button3D(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const G2AddSubScreen(isAddition: true))),
            ...
            child: const Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(height: 4),
                  Text('أفقي وعمودي، بأرقام حتى ٩٩', style: TextStyle(color: Colors.white70)),
                ]),
              ),
            ]),
          ),
          ...
          Button3D(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const G2AddSubScreen(isAddition: false))),
