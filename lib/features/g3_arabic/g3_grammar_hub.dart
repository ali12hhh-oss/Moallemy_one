...
class G3GrammarHub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <(String, String, String, Color, Widget)>[
      ('⏰', 'أزمنة الفعل', 'ماضٍ، مضارع، ومستقبل', const Color(0xFF7C4DFF), const G3VerbTenseScreen()),
      ('❓', 'أدوات الاستفهام', 'من، ماذا، أين، متى، كيف، لماذا، كم', const Color(0xFF2979FF), const G3QuestionWordsScreen()),
      ('🏷️', 'نوع الجملة', 'جملة اسمية أم فعلية؟', const Color(0xFFFF1E7E), const G3SentenceTypeScreen()),
    ];
