...
class G3LettersWordsHub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <(String, String, String, Color, Widget)>[
      ('🔤', 'الحروف', 'كل الحروف الـ٢٨: صوت الحرف واسمه', const Color(0xFF7C4DFF), const LettersScreen()),
      ('📖', 'اقرأ', 'كلمات من حرفين إلى خمسة أحرف، وجمل من ثلاثة أجزاء', const Color(0xFFFF6B35), const G3ReadHub()),
      ('📰', 'القراءة', 'فقرات قصيرة مع أسئلة فهم', const Color(0xFF00C853), const G3ReadingPassageScreen()),
      ('✏️', 'الكتابة الذكية', 'اكتب جملة كاملة والتطبيق يقرأها بصوته', const Color(0xFF00BFA6), const G2WriteRecognizeScreen()),
    ];
