...
class _G3SentenceTypeScreenState extends State<G3SentenceTypeScreen> {
  ...
  void _next() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => VoiceService.arabic(target.sentence));
  }
        ...
        body: Stack(children: [
          Padding(
            ...
            child: Column(children: [
              const Text('الجملة الاسمية تبدأ باسم. الجملة الفعلية تبدأ بفعل.', textAlign: TextAlign.center),
              const SizedBox(height: 26),
              GestureDetector(
                onTap: () => VoiceService.arabic(target.sentence),
                child: Text(target.sentence, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w900), textAlign: TextAlign.center),
              ),
              ...
              Row(children: [
                Expanded(
                  child: Button3D(
                    ...
                    child: const Center(child: Text('اسمية', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Colors.white))),
                  ),
                ),
                ...
                Expanded(
                  child: Button3D(
                    ...
                    padding: const EdgeInsets.symmetric(vertical: 22),
                    child: const Center(child: Text('فعلية', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Colors.white))),
                  ),
                ),
              ]),
            ]),
