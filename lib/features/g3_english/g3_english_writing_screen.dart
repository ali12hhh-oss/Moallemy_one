      ...
      child: Scaffold(
        ...
        body: Stack(children: [
          Column(children: [
            ...
            const Text('اكتب الجملة', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            Text(_targets[index], style: const TextStyle(fontSize: 30, fontWeight: FontWeight.w900), textDirection: TextDirection.ltr),
            const SizedBox(height: 6),
