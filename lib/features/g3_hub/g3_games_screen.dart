...
class G3GamesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(textDirection: TextDirection.rtl, child: Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(18), children: games.map((g) => Padding(
        padding: const EdgeInsets.only(bottom: 16),
        child: Button3D(onTap: () => _openGame(context, g.$5), color: g.$4, padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 20), child: Row(children: [
          Text(g.$1, style: const TextStyle(fontSize: 32)), const SizedBox(width: 14), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(g.$2, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Colors.white)), const SizedBox(height: 3), Text(g.$3, style: const TextStyle(color: Colors.white70, fontSize: 12.5)),
          ])),
        ])),
      )).toList()),
    ));
...
class _ReadingGameState extends State<_ReadingGame> {
  ...
  late ShortWord target; late List<ShortWord> options; int score = 0; String? cheer;
