  ...
  Widget build(BuildContext context) {
    final items = <(String, String, String, Color, Widget)>[
      (
        '🔢',
        'الأرقام',
        'من ١ إلى ٩٩٩٩ على صفحات',
        const Color(0xFF2979FF),
        const G3MathNumbersScreen(),
      ),
      (
        '➕',
        'الجمع والطرح',
      ...
      (
        '✖️',
        'الضرب',
        'جدول الضرب الكامل من ١ إلى ١٠',
        const Color(0xFF7C4DFF),
        const G3MultiplicationScreen(),
      ),
      (
        '➗',
        'القسمة',
        'مفهوم جديد: التوزيع بالتساوي',
        const Color(0xFFFF6B35),
        const G3DivisionScreen(),
      ),
      (
        '🍕',
        'الكسور',
        ...
        const G3FractionsScreen(),
      ),
      (
        '🧩',
        'مسائل كلامية',
        'مسائل متنوعة: جمع، طرح، ضرب، وقسمة',
        const Color(0xFF00BFA6),
        const G3WordProblemsScreen(),
      ),
    ];
