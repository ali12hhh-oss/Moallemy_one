...
class _G3MultiplicationScreenState extends State<G3MultiplicationScreen> {
  int table = 1;
  static const colors = [
    Color(0xFF7C4DFF), Color(0xFF2979FF), Color(0xFFFF6B35), Color(0xFF00C853), Color(0xFFFF1E7E),
    Color(0xFF00BFA6), Color(0xFFFFC107), Color(0xFF8E24AA), Color(0xFF3D5AFE), Color(0xFFE53935),
  ];
              ...
              children: List.generate(10, (i) {
                ...
                return Padding(
                  ...
                  child: Button3D(
                    ...
                    child: Text(arNum(t), style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w900, color: Colors.white)),
                  ),
                );
              }),
            ),
