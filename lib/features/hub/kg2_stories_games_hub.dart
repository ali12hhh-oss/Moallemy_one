    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(padding: const EdgeInsets.all(18), children: [
          Button3D(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const Kg2StoriesScreen())),
            ...
            child: const Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(height: 4),
                  Text('قصتان تعليميتان يمكن الاستماع إليهما بصوت', style: TextStyle(color: Colors.white70)),
                ]),
              ),
            ]),
          ),
          ...
          Button3D(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const Kg2GamesScreen())),
            ...
            child: const Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(height: 4),
                  Text('لعبتان للحروف ولعبتان للأرقام', style: TextStyle(color: Colors.white70)),
                ]),
              ),
            ]),
          ),
