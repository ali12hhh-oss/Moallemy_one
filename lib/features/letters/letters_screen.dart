...
class _S extends State<LettersScreen> {
  int i = 0;
  int form = 0; // 0: أولي، 1: وسطي، 2: أخري
  ...
  // أشكال الحروف العربية عند الكتابة. الحروف التي لا تتصل بما بعدها
  // تحافظ على شكلها الصحيح بدل عرض شكل وسطي غير صحيح.
  ...
  static const List<String> _formNames = ['أولي', 'وسطي', 'أخري'];

  String _displayForm(String letter) {
    final forms = _forms[letter];
    if (forms == null) return letter;
    return forms[form];
  }
                            ...
                            child: Column(
                              children: [
                                AnimatedSwitcher(
                                  ...
                                  child: Text(
                                    _displayForm(l.letter),
                                    key: ValueKey('${l.letter}-$form'),
                                    textDirection: TextDirection.rtl,
