              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(child: SpeakableText('الحرف ${i + 1} من ${arabicLetters.length}')),
                    ...
                    AnimatedSwitcher(
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              SpeakableText(l.letter, style: const TextStyle(fontSize: 96, fontWeight: FontWeight.bold)),
                              const SizedBox(height: 8),
                              SpeakableText('صوت الحرف: ${l.sound}', style: const TextStyle(fontSize: 23)),
                              const SizedBox(height: 4),
                              SpeakableText('اسم الحرف: $name', style: const TextStyle(fontSize: 19)),
                              const SizedBox(height: 4),
                              SpeakableText('${l.emoji}  ${l.word}', style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                              const SizedBox(height: 14),
                              SizedBox(
                                width: double.infinity,
                                child: FilledButton.icon(
                                  onPressed: () => VoiceService.arabicLetterSound(l.letter, fallbackText: l.sound),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: FilledButton.icon(
                            style: _navigationButtonStyle(),
                            onPressed: i == arabicLetters.length - 1 ? null : _next,
