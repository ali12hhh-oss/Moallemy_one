...
class _Kg2PlaceValueScreenState extends State<Kg2PlaceValueScreen> {
  ...
  static String _word(int n) => const {
        1: 'واحد', 2: 'اثنان', 3: 'ثلاثة', 4: 'أربعة', 5: 'خمسة', 6: 'ستة', 7: 'سبعة', 8: 'ثمانية', 9: 'تسعة',
            ...
            child: Row(children: [
              Expanded(
                child: Button3D(
                  ...
                  color: onesMode ? const Color(0xFF2979FF) : const Color(0xFF90CAF9),
                  depth: onesMode ? 2 : 7,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  child: const Center(child: Text('آحاد', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Colors.white))),
                ),
              ),
              ...
              Expanded(
                child: Button3D(
                  ...
                  color: !onesMode ? const Color(0xFF7C4DFF) : const Color(0xFFB39DDB),
                  depth: !onesMode ? 2 : 7,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                  child: const Center(child: Text('عشرات', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Colors.white))),
                ),
              ),
            ]),
          ),
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                return Button3D(
                  onTap: () => VoiceService.arabic('$n${onesMode ? '، من الآحاد' : '، من العشرات'}'),
                  color: onesMode ? const Color(0xFF2979FF) : const Color(0xFF7C4DFF),
                  padding: const EdgeInsets.all(10),
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(arNum(n), style: const TextStyle(fontSize: 30, fontWeight: FontWeight.w900, color: Colors.white)),
                    const SizedBox(height: 6),
                    Text(_word(n), style: const TextStyle(color: Colors.white70, fontSize: 12)),
...
class _DotGroups extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      ...
      spacing: 6,
      runSpacing: 4,
      children: List.generate(groups, (_) => Row(mainAxisSize: MainAxisSize.min, children: List.generate(10, (_) => const _Dot()))),
    );
  }
}
