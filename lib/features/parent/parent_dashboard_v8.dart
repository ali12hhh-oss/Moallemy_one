        ...
        body: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              const ListTile(
                leading: Text('🔎'),
                title: Text('المهارات الضعيفة'),
                subtitle: Text(
                  'تظهر هنا عند إضافة نتائج الأنشطة والاختبارات التفصيلية.',
                ),
              ),
              const ListTile(
                leading: Text('⏱️'),
                title: Text('وقت التعلم'),
                subtitle: Text('يمكن توسيعه مع تسجيل مدة كل درس ونشاط.'),
              ),
              const ListTile(
                leading: Text('🛍️'),
                title: Text('مشتريات المتجر'),
                subtitle: Text('تتم قراءة العناصر المشتراة من التخزين المحلي.'),
              ),
            ],
          ),
        ),
