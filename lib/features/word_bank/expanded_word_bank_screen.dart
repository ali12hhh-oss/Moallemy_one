...
class ExpandedWordBankScreen extends StatefulWidget {
  ...
  @override
  State<ExpandedWordBankScreen> createState() => _ExpandedWordBankScreenState();
}
...
class _ExpandedWordBankScreenState extends State<ExpandedWordBankScreen> {
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  return Card(
                    child: InkWell(
                      onTap: () => VoiceService.arabic(x.word),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(x.emoji, style: const TextStyle(fontSize: 42)),
                            Text(
                              x.word,
                            ...
                            IconButton(
                              onPressed: () => VoiceService.arabic(x.word),
  ...
  Widget _chips(List<String> items, void Function(String) onTap) =>
